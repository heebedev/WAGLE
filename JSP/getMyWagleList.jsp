...
<%
	...
	int mSeqno = Integer.parseInt(request.getParameter("mSeqno"));
    ...
    String WhereDefault = "SELECT wc.* FROM WagleUser AS wu, WagleCreate AS wc WHERE wu.User_uSeqno="+uSeqno+" AND wuValidation=1 AND wcValidation=1 AND wc.Moim_mSeqno="+mSeqno+" AND wc.wcSeqno = wu.wcSeqno ORDER BY wcDueDate DESC";
    int count = 0;
