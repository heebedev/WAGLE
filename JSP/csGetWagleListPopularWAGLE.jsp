...
<%
    ...
    String WhereDefault = "select wc.* from WaGleuser as w, waglecreate as wc where w.wcSeqno = wc.wcSeqno and Moim_mSeqno = '" +  moimSeq + "' and wuValidation = 1 group by w.wcSeqno order by count(*) desc;";
    int count = 0;
