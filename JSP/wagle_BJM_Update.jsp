...
<%
	...
	try {
		...
		String A = "update Suggestion set sValidation = '0' where sSeqno = ?;";

		ps = conn_mysql.prepareStatement(A);

		for (int i = 0 ; i < Integer.parseInt(sCount) ; i++) {

			String sSeqno = request.getParameter("sSeqno" + i);
			
			ps.setInt(1, Integer.parseInt(sSeqno));
			ps.executeUpdate();
		}

		A = "INSERT INTO Suggestion (WagleCreate_wcSeqno, sType, sContent) VALUES (?, 'H', ?)";
