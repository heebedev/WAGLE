...
<%
    ...
    String WhereDefault = "SELECT uImageName, wpReadPage, uSeqno, uLoginType, wpSeqno FROM User AS u, WagleProgress AS wp, WagleUser AS wu WHERE u.uSeqno = wu.User_uSeqno AND wp.WagleUser_wuSeqno = wu.wuSeqno AND WagleCreate_wcSeqno =" + wcSeqno;
    int count = 0;
