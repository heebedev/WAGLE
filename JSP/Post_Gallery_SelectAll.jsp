...
<%
    ...
    String WhereDefault = "select p.pSeqno, pf.pfImageName, p.User_uSeqno from PostFile as pf, Post as p " + 
    		"where p.pValidation = 1 and p.pSeqno = pf.Post_pSeqno and p.Moim_mSeqno = " + moimSeqno + " order by pf.pfSeqno DESC;";
    int count = 0;
