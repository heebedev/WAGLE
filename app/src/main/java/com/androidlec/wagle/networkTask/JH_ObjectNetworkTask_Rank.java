...
public class JH_ObjectNetworkTask_Rank extends AsyncTask<Integer, String, Object> { // 어레이리스트 불러와야 하니깐 오브젝트로 쓴다. 그래야 오브젝트로 바뀜.
    ...
    // Constructor
    public JH_ObjectNetworkTask_Rank(Context context, String mAddr) {
        this.context = context;
        this.mAddr = mAddr;
        this.rankdata = new ArrayList<Rank>();
    }
    ...
    protected Object doInBackground(Integer... integers) {
        ...
        return rankdata; // 다 해놓고 리턴 안하면 꽝이죠~. 이제 parser에 대해서 정리만 해주면 됨.
    }
