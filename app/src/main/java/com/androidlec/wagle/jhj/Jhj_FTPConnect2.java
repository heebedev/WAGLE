...
public class Jhj_FTPConnect2 extends AsyncTask<Integer, String, Boolean> {
    ...
    public Jhj_FTPConnect2(Context context, String host, String username, String password, int port, Uri file, String fileName, String directoryRoot) {
    ...
    protected void onPreExecute() {
        ...
        MakeMoimActivity.MAKEMOIMACT.finish();
    }
